    ...
    with open(key[3]) as f:
        ...
        class DraggableWindow(QWidget):
            ...
            def initUI(self):
                ...
                self.table_widget.setColumnWidth(0, screen.width()//12)
                self.table_widget.setColumnWidth(1, screen.width()//27)
